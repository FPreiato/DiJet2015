  ...
  for(int jj=0; jj<n_bin ; jj++){	 
   ...
   //for (Long64_t jentry=0; jentry<1000;jentry++) {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
     ...
     //     if( (fabs(parton1.Eta())<2.5 && fabs(wj1.Eta())>2.5) || ( fabs(parton2.Eta())<2.5 && fabs(wj2.Eta())>2.5)){
     //     cout<<"parton1.Eta()= "<<parton1.Eta()<<endl;
     //     cout<<"wj1.Eta()= "<<wj1.Eta()<<endl;
     //     cout<<"parton2.Eta()= "<<parton2.Eta()<<endl;
     //     cout<<"wj2.Eta()= "<<wj2.Eta()<<endl;
     //     }  
