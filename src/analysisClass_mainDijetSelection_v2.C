...
void analysisClass::Loop()
{
   ...
   //for (Long64_t jentry=0; jentry<1000;jentry++) {
    ...
    if( Genjet1.Pt()<0 || Genjet2.Pt()<0 ) continue;
 
   // Create dijet(reco) system
    Gendijet = Genjet1 + Genjet2;
    GenMJJ = Gendijet.M();
    GenDeltaEtaJJ = fabs(Genjet1.Eta() - Genjet2.Eta());
    Gen_cosThetaStar = tanh ( GenDeltaEtaJJ/2 ) ;
    ...
    for( Long64_t ijet=0;  ijet<no_Genjets_ak4;  ijet++){
      ...
      CreateAndFillUserTH1D("H_AllGenjet_Phi", 2000, -10. , 10. , currentGenJet.Phi() );
      CreateAndFillUserTH1D("H_AllGenjet_M", 10000, 0. , 10000. , currentGenJet.M() );
    ...
    if( Genwj1.Pt()<0 || Genwj2.Pt()<0 ) continue;
    ...
    CreateAndFillUserTH1D("H_Gendijet_DeltaEta", 100, 0. , 8. , GenDeltaEtaJJ );
    CreateAndFillUserTH1D("H_Gendijet_cosThetaStar", 50, 0. , 1. , Gen_cosThetaStar);
    ...
    CreateAndFillUserTH1D("H_GendijetWide_DeltaEta", 100, 0. , 8. , GenDeltaEtaJJWide );
    ...
    double DeltaR_GenWidejet_parton1 = 1000 ;
    double DeltaR1_GenWidejet_parton1 = Genwj1.DeltaR(parton1);
    double DeltaR2_GenWidejet_parton1 = Genwj2.DeltaR(parton2);

    double     R_PtGenWidejet_PtParton1;
    
    if(DeltaR1_GenWidejet_parton1 < DeltaR2_GenWidejet_parton1){
     
      DeltaR_GenWidejet_parton1 = DeltaR1_GenWidejet_parton1;
      R_PtGenWidejet_PtParton1 = Genwj1.Pt() / parton1.Pt() ;
    }
    else if(DeltaR1_GenWidejet_parton1 > DeltaR2_GenWidejet_parton1){
      
      DeltaR_GenWidejet_parton1 = DeltaR2_GenWidejet_parton1;
      R_PtGenWidejet_PtParton1 = Genwj2.Pt() / parton1.Pt() ;
    }
    
    CreateAndFillUserTH1D("H_DeltaR_GenWidejet_parton1", 100, 0. , 10. , DeltaR_GenWidejet_parton1 );
    
    if(DeltaR_GenWidejet_parton1 <= 0.3){
      //Calcolo ratio con un taglio sensato in DeltaR
      
      CreateAndFillUserTH1D("H_R_PtGenWidejet_PtParton1", 100, 0. , 10. , R_PtGenWidejet_PtParton1 );
      CreateAndFillUserTProfile("Profile_PtGenWide", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtGenWidejet_PtParton1 );  //, Double_t weight)	 
      
      if( fabs( parton1.Eta() ) >= 0. && fabs( parton1.Eta() ) < 0.5 ){ 
	CreateAndFillUserTProfile("Profile_PtGenWide_05", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtGenWidejet_PtParton1 );  //, Double_t weight)	 
      }
      if( fabs( parton1.Eta() ) >= 0.5 && fabs( parton1.Eta() ) < 1. ){ 
	CreateAndFillUserTProfile("Profile_PtGenWide_1", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtGenWidejet_PtParton1 );  //, Double_t weight)	 
      }
      if( fabs( parton1.Eta() ) >= 1. && fabs( parton1.Eta() ) < 1.5 ){ 
	CreateAndFillUserTProfile("Profile_PtGenWide_15", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtGenWidejet_PtParton1 );  //, Double_t weight)	 
      }
      if( fabs( parton1.Eta() ) >= 1.5 && fabs( parton1.Eta() ) < 2. ){ 
	CreateAndFillUserTProfile("Profile_PtGenWide_2", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtGenWidejet_PtParton1 );  //, Double_t weight)	 
      }
      if( fabs( parton1.Eta() ) >= 2. && fabs( parton1.Eta() ) < 2.5 ){ 
	CreateAndFillUserTProfile("Profile_PtGenWide_25", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtGenWidejet_PtParton1 );  //, Double_t weight)	 
      }
    }
    ...
    // Creo, riempio e salvo gli istogrammi     
     ...
     //     CreateAndFillUserTH2D("H_PtWideJJ_EtaWideJJ", 1000, 0., 10000., 120, -10. , 10. , wdijet.Pt(), wdijet.Eta() );
     
     ///////////////////////////////////////////////////////////////////////
     
     double DeltaR1_Widejet_parton1 = wj1.DeltaR(parton1);
     double DeltaR2_Widejet_parton1 = wj2.DeltaR(parton1);
     double DeltaR_Widejet_parton1 = 1000 ;
     
     double     R_PtWidejet_PtParton1;
     
     if(DeltaR1_Widejet_parton1 < DeltaR2_Widejet_parton1){
       
       DeltaR_Widejet_parton1 = DeltaR1_Widejet_parton1;
       R_PtWidejet_PtParton1 = wj1.Pt() / parton1.Pt() ;
     }
     else if(DeltaR1_Widejet_parton1 > DeltaR2_Widejet_parton1){
       
       DeltaR_Widejet_parton1 = DeltaR2_Widejet_parton1;
       R_PtWidejet_PtParton1 = wj2.Pt() / parton1.Pt() ;
     }
     
     CreateAndFillUserTH1D("H_DeltaR_Widejet_parton1", 100, 0. , 10. , DeltaR_Widejet_parton1 );
     
     if(DeltaR_Widejet_parton1 <= 0.3){
       
       CreateAndFillUserTH1D("H_R_PtWidejet_PtParton1", 100, 0. , 10. , R_PtWidejet_PtParton1 );
       CreateAndFillUserTProfile("Profile_PtRecoWide", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );  
       
       //////////////////////// Eta bins

       if(	fabs( parton1.Eta() ) >= 0. && fabs( parton1.Eta() ) < 0.5 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_05", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
       if(	fabs( parton1.Eta() ) >= 0.5 && fabs( parton1.Eta() ) < 1. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_1", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
       if(	fabs( parton1.Eta() ) >= 1. && fabs( parton1.Eta() ) < 1.5 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_15", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
       if(	fabs( parton1.Eta() ) >= 1.5 && fabs( parton1.Eta() ) < 2. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_2", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
       if(	fabs( parton1.Eta() ) >= 2. && fabs( parton1.Eta() ) < 2.5 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_25", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }

       //////////////////////////// pT bins 

       if(	fabs( parton1.Pt() ) >= 0. && fabs( parton1.Pt() ) < 500 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_500", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
       if(	fabs( parton1.Pt() ) >= 500. && fabs( parton1.Pt() ) < 1000. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_1000", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
       if(	fabs( parton1.Pt() ) >= 1000. && fabs( parton1.Pt() ) < 1500. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_1500", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
       if(	fabs( parton1.Pt() ) >= 1500. && fabs( parton1.Pt() ) < 2000. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_2000", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
       if(	fabs( parton1.Pt() ) >= 2000. && fabs( parton1.Pt() ) < 2500 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_2500", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
       if(	fabs( parton1.Pt() ) >= 2500. && fabs( parton1.Pt() ) < 3000 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_3000", 1000, 0. , 10000. , 0., 3., parton1.Pt(), R_PtWidejet_PtParton1 );
       }
     ...
     double DeltaR1_Widejet_GenWidejet1 = wj1.DeltaR(Genwj1);
     double DeltaR2_Widejet_GenWidejet1 = wj2.DeltaR(Genwj1);
     double DeltaR_Widejet_GenWidejet1 = 1000 ;
     
     double     R_PtWidejet_PtGenWidejet1;
     
     if(DeltaR1_Widejet_GenWidejet1 < DeltaR2_Widejet_GenWidejet1){
       
       DeltaR_Widejet_GenWidejet1 = DeltaR1_Widejet_GenWidejet1;
       R_PtWidejet_PtGenWidejet1 = wj1.Pt() / Genwj1.Pt() ;
     }
     else if(DeltaR1_Widejet_GenWidejet1 > DeltaR2_Widejet_GenWidejet1){
       
       DeltaR_Widejet_GenWidejet1 = DeltaR2_Widejet_GenWidejet1;
       R_PtWidejet_PtGenWidejet1 = wj2.Pt() / Genwj1.Pt() ;
     }
     
     CreateAndFillUserTH1D("H_DeltaR_Widejet_GenWidejet1", 100, 0. , 10. , DeltaR_Widejet_GenWidejet1 );


     if(DeltaR_Widejet_GenWidejet1 <= 0.3){

       CreateAndFillUserTH1D("H_R_PtWidejet_PtGenWidejet1", 100, 0. , 10. , R_PtWidejet_PtGenWidejet1 );
       CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );  

       ///////////////////////// Eta bins
       
       if(	fabs( Genwj1.Eta() ) >= 0. && fabs( Genwj1.Eta() ) < 0.5 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_05", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
       if(	fabs( Genwj1.Eta() ) >= 0.5 && fabs( Genwj1.Eta() ) < 1. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_1", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
       if(	fabs( Genwj1.Eta() ) >= 1. && fabs( Genwj1.Eta() ) < 1.5 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_15", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
       if(	fabs( Genwj1.Eta() ) >= 1.5 && fabs( Genwj1.Eta() ) < 2. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_2", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
       if(	fabs( Genwj1.Eta() ) >= 2. && fabs( Genwj1.Eta() ) < 2.5 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_25", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }

       ///////////////////////// Pt bins

       if(	fabs( Genwj1.Pt() ) >= 0. && fabs( Genwj1.Pt() ) < 500 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_500", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
       if(	fabs( Genwj1.Pt() ) >= 500. && fabs( Genwj1.Pt() ) < 1000. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_1000", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
       if(	fabs( Genwj1.Pt() ) >= 1000. && fabs( Genwj1.Pt() ) < 1500. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_1500", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
       if(	fabs( Genwj1.Pt() ) >= 1500. && fabs( Genwj1.Pt() ) < 2000. ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_2000", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
       if(	fabs( Genwj1.Pt() ) >= 2000. && fabs( Genwj1.Pt() ) < 2500 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_2500", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
       if(	fabs( Genwj1.Pt() ) >= 2500. && fabs( Genwj1.Pt() ) < 3000 ){ 
	 CreateAndFillUserTProfile("Profile_PtRecoWide_PtGenWide_3000", 1000, 0. , 10000. , 0., 3., Genwj1.Pt(), R_PtWidejet_PtGenWidejet1 );
       }
     }
